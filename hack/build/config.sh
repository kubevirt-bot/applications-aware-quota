...
LABEL_SIDECAR_IMAGE_NAME=${LABEL_SIDECAR_IMAGE_NAME:-kubevirt-sidecar}
...
BUILDER_IMAGE=${BUILDER_IMAGE:-quay.io/bmordeha/kubevirt-aaq-bazel-builder:2312051300-701cf00}
