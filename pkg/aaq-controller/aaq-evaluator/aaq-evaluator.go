...
func NewAaqEvaluator(podInformer cache.SharedIndexInformer, aaqAppUsageCalculator *AaqEvaluatorsRegistry, clock clock.Clock) *AaqEvaluator {
	podEvaluator := core.NewPodEvaluator(nil, clock)
	return &AaqEvaluator{
		podEvaluator:                 podEvaluator,
		podInformer:                  podInformer,
		aaqAppUsageEvaluatorRegistry: aaqAppUsageCalculator,
	}
}

type AaqEvaluator struct {
	podEvaluator                 v12.Evaluator
	aaqAppUsageEvaluatorRegistry *AaqEvaluatorsRegistry
...
func (aaqe *AaqEvaluator) Usage(item runtime.Object) (corev1.ResourceList, error) {
	...
	rl, err := aaqe.aaqAppUsageEvaluatorRegistry.Usage(*pod, podsState)
	if err != nil {
...
func (aaqe *AaqEvaluator) CalculatorUsage(item runtime.Object, items []runtime.Object) (corev1.ResourceList, error) {
	...
	rl, err := aaqe.aaqAppUsageEvaluatorRegistry.Usage(pod, pods)
	if err != nil {
		return aaqe.podEvaluator.Usage(item)
	}
	return rl, err
